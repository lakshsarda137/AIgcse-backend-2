...
loader=DirectoryLoader('/Users/LakshSarda/PycharmProjects/pythonProject3/Computer_Science_Chatbot/Biology_chatbot/explainer_bio',loader_cls=PyPDFLoader)
docs=loader.load()
...
def biology_explainer(question,history):
    sentences=history
    ...
    You are a component of a chatbot that helps explain concepts to students in biology specific to only the IGCSE 
    academic curriculum like a biology teacher. You have been given a set of pdfs that explain various concepts relevant to the syllabus of biology in IGCSE
    ...
    is not necessary that everything related to biology is in the notes. The notes are just confined to the iGCSE
    biology syllabus and therefore your answers must also be confined to the IGCSE biology syllabus. Please answer
    ...
    knowledge. Your answer should be comprehensive and help the user understand the answer to their question very well.
    {context}
    Question: {question}
...
def add_item():
    data = request.json
    return biology_explainer (data["question"], data["memory"]),201
