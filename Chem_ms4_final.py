...
chemistry_docs=DirectoryLoader('/Users/LakshSarda/PycharmProjects/pythonProject3/Computer_Science_Chatbot/Chemistry_chatbot/question_papers_chem',loader_cls=PyPDFLoader)
chemistry_documents=chemistry_docs.load()
text_splitter=RecursiveCharacterTextSplitter(
    chunk_size=500,
    chunk_overlap=200,
    add_start_index=True
)
split_docs=text_splitter.split_documents(chemistry_documents)
...
syllabus_loader=PyPDFLoader('/Users/LakshSarda/PycharmProjects/pythonProject3/Computer_Science_Chatbot/Chemistry_chatbot/Chemistry syllabus.pdf')
...
def chem_ms_4(question,predefined_history):
    ...
    You are a component of a chatbot specifically designated to output all content in the IGCSE chemistry
    Syllabus corresponding to the user's question. This is the process you should follow:
    1. Identify key words in the user's question which could include technical chemistry terms etc.
    ...
    You are a chatbot specifically designed to give answers to user questions in exact answer-key language in Chemistry
    ...
    4.  If relevant documents were retrieved,  you must try to output an answer from the answer key as it is without missing out points.
        ...
        Please make sure that the answer you output is factually correct by making sure that the answer makes sense to you- a chemistry
         teacher.
...
def add_item():
    ...
    return chem_ms_4 (data["question"], data["memory"]),201
