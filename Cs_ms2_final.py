...
computer_science_all=DirectoryLoader('/Users/LakshSarda/PycharmProjects/pythonProject3/Computer_Science_Chatbot/CS_chatbot/question_papers_cs2_all',loader_cls=PyPDFLoader)
...
def cs_ms(question,predefined_history):
    ...
    retriever_mmr=db_new.as_retriever(
    ...
    2. Output all content which is the answer to user question from the answer keys without leaving out any point, and make sure to
    answer all strands of the question completely.
    ...
    print (retriever_mmr.invoke(question))
