...
physics_docs=DirectoryLoader('/Users/LakshSarda/PycharmProjects/pythonProject3/Computer_Science_Chatbot/Physics_chatbot/question_papers_phy6_all',loader_cls=PyPDFLoader)
...
def phy_ms_6(question,predefined_history):
...
def add_item():
    data = request.json   
    return phy_ms_6 (data["question"], data["memory"]),201
