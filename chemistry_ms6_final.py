...
chemistry_docs=DirectoryLoader('/Users/LakshSarda/Desktop/Back-end-AIgcse/Test/Chemistry_chatbot/question_papers_chem6_all',loader_cls=PyPDFLoader)
...
syllabus_loader=PyPDFLoader('/Users/LakshSarda/Desktop/Back-end-AIgcse/Test/Chemistry_chatbot/Chemistry syllabus.pdf')
...
def chem_ms_6(question,predefined_history):
...
def add_item():
    data = request.json   
    return chem_ms_6 (data["question"], data["memory"]),201
